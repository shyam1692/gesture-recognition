'''
Here we explore Transfer Learning from VGG 16 Net. We save bottleneck features and then add additional layers
for our classification problem.
Parts of the code here is sourced from sample example provided on keras website
...
#Kindly ignore the code below this point
'''
def predict():
    # load the class_indices saved in the earlier step
    class_dictionary = np.load('class_indices.npy').item()
